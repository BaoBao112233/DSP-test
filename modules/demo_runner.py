...
def run_all(show_plots: bool = True):
    ...
    signal_ops_result = demo_signal_ops(show_plots=show_plots)
    z_result = demo_z_transform(show_plots=show_plots)
    fir_result = demo_fir(show_plots=show_plots)
    iir_result = demo_iir(show_plots=show_plots)
    ...
    notch_result = demo_notch(show_plots=show_plots)
    echo_result = demo_echo(show_plots=show_plots)
